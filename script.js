...
*/
function addTextToImage(imageUrl, data) {
    return __awaiter(this, void 0, void 0, function () {
        var font, image;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Jimp.loadFont(Jimp.FONT_SANS_32_BLACK)];
                case 1:
                    font = _a.sent();
                    return [4 /*yield*/, Jimp.read(imageUrl)];
                case 2:
                    image = _a.sent();
                    // image.print(font, 560, 224, 'Hello World!');
                    data.forEach(function (datum) { return image.print(font, datum.x, datum.y, datum.text); });
